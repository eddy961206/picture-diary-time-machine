...
사진 한 장이나 일기 몇 줄만 넣으면, 2010년대 초등학교 2학년 남자아이의 여름방학 숙제 같은 `그림일기` 이미지로 바꿔주는 작은 웹앱이야.

처음 보는 사람도 바로 감이 오게, 결과 이미지를 앞에 두는 방식으로 정리했어.
...
이 프로젝트는 사진과 짧은 메모를 넣으면, 진짜 초등학생 그림일기 같은 결과물로 바꿔주는 이미지 생성 도구야.
